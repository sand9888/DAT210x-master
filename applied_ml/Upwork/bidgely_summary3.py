...
def quantile_number(quant_number=5, min_est_level=10000):
    ...
    for iii in list_month:
        # heating
        list_med_heating2.append(df_final_heating.loc[df_final_heating['Month'] == iii, 'Average-error(% of raw)'].median())
        list_mean_heating2.append(df_final_heating.loc[df_final_heating['Month'] == iii, 'Average-error(% of raw)'].mean())
        list_20_heating2.append(df_final_heating.loc[df_final_heating['Month'] == iii, 'Average-error(% of raw)'].quantile(q=0.2))
        list_80_heating2.append(df_final_heating.loc[df_final_heating['Month'] == iii, 'Average-error(% of raw)'].quantile(q=0.8))
        # cooling
        list_med_cooling2.append(df_final_cooling.loc[df_final_cooling['Month'] == iii, 'Average-error(% of raw)'].median())
        list_mean_cooling2.append(df_final_cooling.loc[df_final_cooling['Month'] == iii, 'Average-error(% of raw)'].mean())
        list_20_cooling2.append(df_final_cooling.loc[df_final_cooling['Month'] == iii, 'Average-error(% of raw)'].quantile(q=0.2))
        list_80_cooling2.append(df_final_cooling.loc[df_final_cooling['Month'] == iii, 'Average-error(% of raw)'].quantile(q=0.8))
    # heating
