...
df = pd.read_csv('C:/DAT210x-master/Module5/Datasets/CDR.csv')
...
user1 = df[df.In == int(phone_list[0])]
#user1 = df.loc[df.In == phone_list[0]]




# INFO: Plot all the call locations
#user1.plot.scatter(x='TowerLon', y='TowerLat', c='green', alpha=0.1, title='Call Locations')
...
#user1 = user1.loc[((df.CallTime < "06:00:00") | (df.CallTime > "22:00:00"))]
print(user1.shape)
...
ax.scatter(user1.TowerLon, user1.TowerLat, marker='.', c='green',alpha=0.3)
