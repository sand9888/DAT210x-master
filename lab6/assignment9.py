...
# called X:
#
X = pd.read_csv('C:/DAT210x-master/Module5/Datasets/College.csv')
X.colums = ['College','Private','Apps','Accept','Enroll','Top10perc','Top25perc',	'F.Undergrad',	'P.Undergrad',	'Outstate',	'Room.Board',	'Books',	'Personal',	'PhD',	'Terminal',	'S.F.Ratio',	'perc.alumni',	'Expend',	'Grad.Rate'
]
...
# a random_state of 7.
#
a_slice = X[['Room.Board']]
b_slice = X[['Accept']]
X_train, X_test, y_train, y_test = train_test_split(a_slice, b_slice, test_size=0.3, random_state=7)
