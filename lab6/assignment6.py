...
mat = scipy.io.loadmat('C:/DAT210x-master/Module4/Datasets/face_data.mat')
...
# loaded it correctly.
y = pd.read_csv('C:/DAT210x-master/Module5/Datasets/face_labels.csv', header=None)
print(y.shape)
...
if Test_PCA:
  ...
  iso.fit(X_train)
  iso.transform(X_train)
  iso.transform(X_test)
