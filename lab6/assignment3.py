...
def doKMeans(datas, clusters=4):
  ...
  ax.scatter(datas.TowerLat, datas.TowerLon, marker='.', c='green', alpha=0.3)
...
user1 = user1[(user1.CallTime > '00:00:00') & (user1.CallTime < '17:00:00')]
print(user1)
