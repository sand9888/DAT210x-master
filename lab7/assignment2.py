...
X_train, X_test, y_train, y_test = load('C:/DAT210x-master/Module6/Datasets/optdigits.tes', 'C:/DAT210x-master/Module6/Datasets/optdigits.tra')
...
#
guess_1000th_test_value = model.predict(X_test.ix[1000])
